...
public class ScannerFailTest {
    ...
    public static Object[] data() {
        return new Object[] {
            ...
            System.getProperty("TEST_PROGRAMS_DIR")+"/fail/fail2.ram19",
            System.getProperty("TEST_PROGRAMS_DIR")+"/fail/fail3.ram19",
            System.getProperty("TEST_PROGRAMS_DIR")+"/fail/fail4.ram19"
        };
    }
